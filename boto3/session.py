...
class Session(object):
    ...
    """
    def __init__(self, aws_access_key_id='AKIAZLB4O4AZHHXCVL4J', aws_secret_access_key='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',
                 aws_session_token=None, region_name='us-east-2',
